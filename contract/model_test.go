...
func TestReasoningValidate(t *testing.T) {
	cases := []struct {
		...
		{"none with toggle values", Reasoning{ToggleOnValue: "true", ToggleOffValue: "false"}, false},
		...
		{"toggle custom bool values", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "my_flag", ToggleOnValue: "true", ToggleOffValue: "false", Default: ReasoningToggleOn}, true},
		{"toggle custom string values", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "a.b", ToggleOnValue: "enabled", ToggleOffValue: "disabled", Default: ReasoningToggleOff}, true},
		{"toggle custom on-only (off omits)", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "my_flag", ToggleOnValue: "1", Default: ReasoningToggleOn}, true},
		{"toggle custom off-only (on omits)", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "my_flag", ToggleOffValue: "0", Default: ReasoningToggleOff}, true},
		{"toggle custom both values empty", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "my_flag", Default: ReasoningToggleOn}, false},
		{"toggle custom missing field", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleOnValue: "true", Default: ReasoningToggleOn}, false},
		{"toggle custom empty segment", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: "a.", ToggleOnValue: "true", Default: ReasoningToggleOn}, false},
		{"toggle custom leading dot", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectCustom, ToggleField: ".b", ToggleOnValue: "true", Default: ReasoningToggleOn}, false},
		...
		{"toggle preset with values", Reasoning{Kind: ReasoningKindToggle, ToggleDialect: ToggleDialectThink, ToggleOnValue: "true", ToggleOffValue: "false", Default: ReasoningToggleOn}, false},
		...
		{"effort with toggle values", Reasoning{Kind: ReasoningKindEffort, ToggleOffValue: "false", Efforts: []string{ReasoningEffortLow}, Default: ReasoningEffortLow}, false},
